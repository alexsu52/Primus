...
2>&1 | tee log_32_fp8_pp_16_mbs_1_gbs_8192_turbo_deepep_recompute_selective_moe_vpp_4_precision_aware_rope_fusion_sync_moe_1_turbo_rms_norm_auto_tune_250_iters.txt
